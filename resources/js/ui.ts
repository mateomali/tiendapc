...
export const siteAnnouncement = {
    ...
    shellCatalog:
        'mt-0 grid grid-cols-[30px_minmax(0,1fr)_30px] items-center gap-[0.18rem] overflow-hidden rounded-none border-y border-[rgba(119,183,255,0.34)] border-x-0 bg-[linear-gradient(90deg,#345fba_0%,#1f4f98_20%,#173d78_50%,#1c5d9f_82%,#2198c8_100%)] p-[0.04rem_0.22rem] shadow-[inset_0_1px_0_rgba(255,255,255,0.06),inset_0_-1px_0_rgba(5,18,48,0.14)] max-[860px]:mt-0 max-[860px]:grid-cols-[24px_minmax(0,1fr)_24px] max-[860px]:justify-items-stretch max-[860px]:gap-[0.08rem] max-[860px]:rounded-none max-[860px]:border max-[860px]:border-[rgba(119,183,255,0.30)] max-[860px]:p-[0.08rem_0.08rem] max-[860px]:shadow-[inset_0_1px_0_rgba(255,255,255,0.05)] max-[560px]:gap-[0.06rem] max-[560px]:p-[0.07rem_0.06rem]',
    arrow:
    ...
    arrowCatalog:
        `${interactiveLift} inline-flex min-h-[24px] w-[24px] min-w-[24px] items-center justify-center rounded-full border border-[rgba(178,224,255,0.46)] bg-[rgba(225,244,255,0.16)] text-[0.9rem] font-black leading-none text-[#eaf7ff] shadow-[inset_0_1px_0_rgba(255,255,255,0.16),0_5px_12px_rgba(4,18,55,0.16)] backdrop-blur-[6px] hover:border-[rgba(191,235,255,0.74)] hover:bg-[rgba(231,247,255,0.26)] hover:text-white hover:shadow-[0_7px_16px_rgba(30,129,220,0.16),0_0_0_2px_rgba(116,207,255,0.12),inset_0_1px_0_rgba(255,255,255,0.22)] disabled:cursor-not-allowed disabled:opacity-35 disabled:transform-none disabled:brightness-100 disabled:shadow-none max-[860px]:min-h-[24px] max-[860px]:w-[24px] max-[860px]:min-w-[24px] max-[860px]:border-[rgba(183,225,255,0.36)] max-[860px]:bg-[rgba(228,246,255,0.18)] max-[860px]:text-[0.86rem] max-[860px]:shadow-[inset_0_1px_0_rgba(255,255,255,0.12),0_4px_8px_rgba(5,24,62,0.12)] max-[560px]:min-h-[22px] max-[560px]:w-[22px] max-[560px]:min-w-[22px] max-[560px]:text-[0.78rem]`,
    card:
...
export const catalogOfferRibbonClass =
    'absolute left-[-2.75rem] top-[1.05rem] z-[4] flex h-[1.8rem] min-w-[10.6rem] -rotate-45 items-center justify-center gap-0 bg-[linear-gradient(180deg,#ff4b4b_0%,#d71920_58%,#a80f17_100%)] px-[2.15rem] text-[0.68rem] font-black uppercase tracking-[0.055em] text-white shadow-[0_9px_20px_rgba(168,15,23,0.34),0_0_18px_rgba(255,99,99,0.24)] max-[560px]:left-[-2.58rem] max-[560px]:top-[0.84rem] max-[560px]:h-6 max-[560px]:min-w-[8.7rem] max-[560px]:px-[1.6rem] max-[560px]:text-[0.56rem] max-[560px]:tracking-[0.045em] max-[560px]:shadow-[0_7px_14px_rgba(168,15,23,0.26)]';
export const catalogOfferRibbonTextClass =
    'relative z-[1] text-[0.92rem] font-black leading-none tracking-[0.02em] [text-shadow:0_2px_8px_rgba(5,23,62,0.30)] max-[560px]:text-[0.82rem]';
export const catalogOfferRibbonIconClass =
    'relative z-[1] inline-flex items-center justify-center text-[0.82rem] leading-none drop-shadow-[0_3px_6px_rgba(5,23,62,0.24)] max-[560px]:text-[0.74rem]';
